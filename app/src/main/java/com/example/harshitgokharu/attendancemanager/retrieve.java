...
public class retrieve extends AppCompatActivity  implements NavigationView.OnNavigationItemSelectedListener {
                ...
                .addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (document.exists()) {
                                Toast.makeText(retrieve.this, "FETCHING SUBJECTS", Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(retrieve.this, "Error getting documents.", Toast.LENGTH_SHORT).show();
                        }
                    }
    ...
    private void display(String course) {
        Intent j = new Intent(retrieve.this, show.class);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        if(id==R.id.home)
        {
            Intent j = new Intent(retrieve.this, SecondActivity.class);
            startActivity(j);
        }
        else if(id==R.id.profile)
        {
            Intent j=new Intent(retrieve.this,third.class);
            startActivity(j);
        }
        else if(id==R.id.retrieve)
        {
            Intent j=new Intent(retrieve.this,retrieve.class);
            startActivity(j);
        }
        return false;
    }
